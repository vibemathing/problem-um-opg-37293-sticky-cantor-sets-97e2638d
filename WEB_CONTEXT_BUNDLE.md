...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-37293-sticky-cantor-sets-97e2638d-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-37293"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-37293-sticky-cantor-sets-97e2638d-v1",
      "problem_contract_sha256": "76a6f6575fa494d94fa48910ebc26ba7360c3e3aa386c48db61ab27289d95d64",
      "problem_id": "problem:um-opg-37293-sticky-cantor-sets-97e2638d",
      "route_id": "route:um-opg-37293-sticky-cantor-sets-97e2638d-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-37293-sticky-cantor-sets-97e2638d-source-fidelity-01",
      "graph_id": "graph:um-opg-37293-sticky-cantor-sets-97e2638d-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-37293-sticky-cantor-sets-97e2638d-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-37293-sticky-cantor-sets-97e2638d-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Let $C$ be a Cantor set embedded in $\\mathbb{R}^n$. Is there a self-homeomorphism $f$ of $\\mathbb{R}^n$ for every $\\epsilon$ greater than $0$ so that $f$ moves every point by less than $\\epsilon$ and $f(C)$ does not intersect $C$? Such an embedded Cantor set for which no such $f$ exists (for some $\\epsilon$ ) is called \"sticky\". For what dimensions $n$ do sticky Cantor sets exist?"
          },
          "statement_sha256": "11f0120ddaacb8c30c0c039ea7593a665a5d76084598182e54fa1627c920a30a"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-37293-sticky-cantor-sets-97e2638d-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-37293-sticky-cantor-sets-97e2638d-root",
      "route_id": "route:um-opg-37293-sticky-cantor-sets-97e2638d-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37293-9031f91dc2ba",
        "url": "https://www.unsolvedmath.com/problems/OPG-37293"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
